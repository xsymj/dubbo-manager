 ...
 *
 */
package cn.com.haomi.common.core.dao.imp;
 ...
 * @param <T>
 */
public abstract class BaseDaoImp<T extends BaseEntity> extends SqlSessionDaoSupport implements BaseDao<T>{
	
	protected static final Logger log = LoggerFactory.getLogger(BaseDaoImp.class);
